...
export default function Navigation() {
  ...
  const navItems = [
    { label: "Journey & Education", id: "stats-education", visible: true },
    { label: "Showcase", id: "showcase", visible: data.settings?.showProjects && data.projects && data.projects.length > 0 },
    { label: "Skills", id: "skills", visible: data.settings?.showSkills && data.skills && data.skills.length > 0 },
    { label: "Achievements", id: "achievements", visible: data.settings?.showAchievements && data.achievements && data.achievements.length > 0 },
    { label: "Contact", id: "contact", visible: data.settings?.showContact && data.contact && Object.keys(data.contact).length > 0 },
