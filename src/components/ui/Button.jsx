...
export default function Button({ variant = "primary", children, onClick, className = "", ...props }) {
  ...
  switch (variant) {
    case "primary":
      variantClasses = "bg-accent text-white hover:bg-accent-dark hover:shadow-lg hover:shadow-accent/30";
      break;
    case "outline":
      ...
      break;
    case "ghost":
      variantClasses = "text-accent hover:bg-card/50 hover:text-accent-dark";
      break;
    default:
